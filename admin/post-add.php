...
<div class="content-wrapper">
    <form action="post_crud.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div id="menu" class="card-collapse collapsed in">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-info btn-sm" type="submit" name="savedraft">Save Draft</button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            <?php  
                                                $stmt = dbtable_order('*', 'categories', 'id desc'); 
                                                foreach ($stmt as $row) { 
                                                    if ($row>0) {
                                                        echo '  <tr><td> <input name="checkbox[]" type="checkbox" value=" ' . $row['cat_key'] . ' "/> </td><td> ' . $row['name'] . '</td></tr>';
                                                    } 
                                                    else {
