...
$linkrel = 1; include('Admin/includes/header.php'); 
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div style="" class="auth-form-light text-left py-5 px-4 px-sm-5"> 
              ...
              <form class="pt-3" action="signup.php" method="POST">
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-sm" name="rePassword" id="rePassword" placeholder="rePassword" required>
                </div>
                <div class="mb-4">
